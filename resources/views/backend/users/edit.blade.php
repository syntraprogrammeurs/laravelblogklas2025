                    ...
                    <div class="card w-100 h-100">
                        ...
                        <div class="card-body text-center">
                            @if($user->photo && $photoDetails['exists'])
                                <img src="{{ asset('assets/img/' . $user->photo->path) }}" alt="{{ $user->photo->alternate_text ?? $user->name }}" class="img-fluid rounded object-fit-cover mb-2" style="width: 100%; max-width: 300px; height: auto;">
                                <div class="mt-2">
                                    <small>
                            ...
                            @else
                                <img src="https://placehold.co/300x300" alt="No Image" class="img-fluid rounded object-fit-cover mb-2" style="width: 100%; max-width: 300px; height: auto;">
                                <div class="mt-2"><small>No photo available</small></div>
                            @endif
                        </div>
                        <div class="card-footer">
